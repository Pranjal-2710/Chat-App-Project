    ...
    <div className={`bg-[#8185B2]/10 h-full p-5 rounded-r-xl overflow-y-scroll text-white ${selectedUser ? 
        ...
        <div className='pb-5'>
            <div className="flex justify-between items-center">
                <img src={icon} alt="logo" className='max-w-40'/>
                <div className='relative py-2 group'>
                    <img src={threedots} alt="Menu" className='max-h-10 cursor-pointer'/>
            ...
            <div className='bg-[#282142] rounded-full flex items-center gap-2 py-3 px-4 mt-5'>
                ...
                <input onChange={(e)=>setInput(e.target.value)} type="text" className="bg-transparent border-none outline-none text-white text-xl placeholder-[#c8c8c8] flex-1" placeholder='Search User....' ></input>
            </div>
        </div>
        ...
        <div className='flex flex-col'>
            {filteredUsers.map((user,index)=>(
                ...
                ${selectedUser ?._id ===user._id && 'bg-[#282142]/50'}`}>
                    <img src={user?.profilePic || avatar} alt="" className='w-[35px] aspect-[1/1] rounded-full' />
